        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                          ...
                          >
                            ...
                            {isExpanded && hasImage && (
                              ...
                              >
                                ...
                                <div className="relative w-full h-72 max-h-96 overflow-hidden rounded-lg border-2 border-blue-300 dark:border-blue-500">
                                  <Image
                                    ...
                                    height={600}
                                    unoptimized
                                    className="w-full h-full object-contain bg-black/10 cursor-pointer hover:opacity-95 transition-opacity"
                                    onClick={() => hideCardImage(cardId)}
                                    onError={() => {
                                      setErrorCards((prev) => ({
                                        ...prev,
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 text-center">
                                  AI-generated exercise form guide • Click image
                                  or X to hide
                                </p>
                              </div>
                            )}
          ...
          <section className="space-y-4">
            <div className="border-b-2 border-green-500 pb-3 mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                Balanced meal plan matched to your dietary preferences and
                caloric needs
              </p>
            </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            {!hasImage && !isExpanded && (
                              <button
                                onClick={() =>
                                  toggleCardImage(cardId, meal.name, "meal")
                                }
                                disabled={isLoading}
                            ...
                            {isExpanded && hasImage && (
                              ...
                              >
                                ...
                                <Image
                                  ...
                                  height={600}
                                  unoptimized
                                  className="w-full h-full max-h-96 rounded-lg border-2 border-green-300 dark:border-green-500 object-contain bg-black/10 cursor-pointer hover:opacity-95 transition-opacity"
                                  onClick={() => hideCardImage(cardId)}
                                  onError={() => {
                                    setErrorCards((prev) => ({
                                      ...prev,
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 text-center">
                                  AI-generated meal presentation • Click image
                                  or X to hide
                                </p>
                              </div>
                            )}
