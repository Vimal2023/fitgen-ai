  ...
  "
    ...
    "
      ...
      <DialogContent className="sm:max-w-md bg-neutral-900/80 backdrop-blur-xl border border-neutral-700 rounded-2xl shadow-2xl p-6 text-white">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold bg-linear-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
            Listen to Your Plan
          </DialogTitle>
        ...
        <div className="space-y-5 py-4">
          ...
          <div className="flex flex-col gap-3">
            {!isPlaying ? (
              <Button
                onClick={speak}
                className="w-full py-4 rounded-xl bg-linear-to-r from-green-500 to-emerald-600 hover:brightness-110 text-white font-semibold shadow-lg"
              >
